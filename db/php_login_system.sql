...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Mar 24, 2022 at 07:30 AM
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8 COMMENT='admin and customer users';
...
(1, 'Mike', 'Dalisay', 'mike@example.com', '0999999999', 'Blk. 24 A, Lot 6, Ph. 3, Peace Village', '$2y$10$AUBptrm9sQF696zr8Hv31On3x4wqnTihdCLocZmGLbiDvyLpyokL.', 'Admin', '', 1, '2015-03-24 07:00:21', '2016-06-13 11:17:47'),
(2, 'Lauro', 'Abogne', 'lauro@eacomm.com', '08888888', 'Pasig City', '$2y$10$it4i11kRKrB19FfpPRWsRO5qtgrgajL7NnxOq180MsIhCKhAmSdDa', 'Customer', '', 1, '2015-03-24 07:00:21', '2015-03-24 00:00:21'),
...
(27, 'sout', 'ruoshim', 'sout.rahim@gmail.com', '11362283', 'uio', '$2y$10$klvtKv9iJvJVzTdkkZ9Fa.t3uepiVjqCJnawvXKD8jvvgKcpRwB8u', 'Customer', 'pUv0YVPr9Ri0NpSGY7htWa47cmllAsgF', 1, '2022-03-24 15:12:11', '2022-03-24 07:29:46');
COMMIT;
